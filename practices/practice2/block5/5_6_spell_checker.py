# Реализуйте простую систему проверки орфографии с помощью функции
# вычисления расстояния Левенштейна. Для работы потребуется словарь
# русских слов с указанием частот встречаемости.
